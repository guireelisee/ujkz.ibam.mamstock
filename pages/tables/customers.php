                    ...
                    <tbody>
                      <?php foreach ($clients as $client) : ?>
                        <tr>
                          ...
                          <td>
                            <button type="button" id="edit" data-type="edit"
                            data-id="<?php echo $client['idClient'] ?>"
                            data-nom="<?php echo $client['nomClient'] ?>"
                            data-prenom="<?php echo $client['prenomClient'] ?>"
                            data-email="<?php echo $client['emailClient'] ?>"
                            data-tel="<?php echo $client['telClient'] ?>"
                            data-adresse="<?php echo $client['adresseClient'] ?>"
                            data-struct="<?php echo $client['nomStructClient'] ?>" data-toggle="modal" data-target="#modal-lg" class="btn btn-success btn-sm"><i class="fa fa-edit"></i>
                            </button>
