                  ...
                  <div class="row">
                    <div class="col-md-5">
                      <div class="form-group">
                        ...
                        // récupère la date du jour en timestamp
                        ...
                        ?>
                        <input type="date" class="form-control" id="dateDebut" placeholder="Code" value=<?= $dateVeille ?> max=<?= $dateVeille ?>>
                      </div>
                    </div>
                    <div class="col-md-5">
                      <div class="form-group">
                        <label for="codeProduit">Date fin</label>
                        <input type="date" class="form-control" id="dateFin" placeholder="Code" value="<?= $date ?>" max=<?= $date ?>>
                      </div>
                    </div>
                    <div class="col-md-2">
                      <div class="form-group">

                        <label for="codeProduit" style="visibility: hidden">.</label>
