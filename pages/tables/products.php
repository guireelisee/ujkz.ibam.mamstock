                      ...
                      <?php foreach ($produits as $produit): ?>
                          <tr>
                            ...
                            <td>
                              ...
                              data-code="<?php echo $produit['codeProduit'] ?>"
                              data-libele="<?php echo $produit['libelleProduit'] ?>"
                              data-idcategorie="<?php echo $produit['idCategorie'] ?>"
                              data-stockactuel="<?php echo $produit['stockActuelProduit'] ?>"
                              data-prixunit="<?php echo $produit['prixUnit'] ?>"
                              data-prixachat="<?php echo $produit['prixAchat'] ?>"
                              data-idemplacement="<?php echo $produit['idEmplacement'] ?>"
                              data-qtemin="<?php echo $produit['qteProduitMin'] ?>"
                              data-qtemax="<?php echo $produit['qteProduitMax'] ?>"
                              data-unite="<?php echo $produit['unite'] ?>"
                              data-toggle="modal"
                              data-target="#modal-lg" class="btn btn-success btn-sm"><i class="fa fa-edit"></i>
                              </button>
...
<div class="modal" id="confirm-modal" tabindex="-1" role="dialog">
  ...
  <?php if (isset($_POST['submit'])):?>
      <?php
        ...
        $prixAchat = $_POST['prixAcaht'];
        $unite = $_POST['unite'];
        if ($unite === 'Autres') {
        $unite = $_POST['autre'];
        }
        $produit = new Produit($codeProduit, $categorieProduit, $libelleProduit, $qteMinimal, $qteMaximal, $qteActuel, $prixUnit, $prixAchat, $emplacementProduit, $unite);
