...
class Produit
{
    ...
    public function __construct($codeProduit, $idCategorie, $libelleProduit, $stockMin, $stockMax, $stockActuel, $prixUnitaire, $prixAchat, $emplacement, $unite)
    {
    ...
    public static function create(Produit $produit)
    {
        ...
        if (count($produits) === 0) {
            $pdoStat = $bdd->prepare('INSERT INTO produits VALUES (:idProduit, :codeProduit, :idCategorie, :libelleProduit, :qteProduitMin, :qteProduitMax, :stockActuelProduit, :prixUnit, :idEmplacement, :unite)');
